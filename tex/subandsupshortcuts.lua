...
return {
	...
	s(
		{ trig = "([%a%)%]%}])yy", regTrig = true, wordTrig = false, snippetType = "autosnippet" },
		fmta("<>_{<>}", {
			f(function(_, snip)
				return snip.captures[1]
			end),
	...
	s(
		{ trig = "([%a%)%]%}])zz", regTrig = true, wordTrig = false, snippetType = "autosnippet" },
		fmta("<>_{<>}", {
			f(function(_, snip)
				return snip.captures[1]
			end),
	...
	s(
		{ trig = "([%a%)%]%}])cj", regTrig = true, wordTrig = false, snippetType = "autosnippet" },
		fmta("<>^{<>}", {
			f(function(_, snip)
				return snip.captures[1]
			end),
	...
	s(
		{ trig = "([%a%)%]%}])dg", regTrig = true, wordTrig = false, snippetType = "autosnippet" },
		fmta("<>^{<>}", {
			f(function(_, snip)
				return snip.captures[1]
			end),
	...
	s(
		{ trig = ".eff", snippetType = "autosnippet", priority = 1001, dscr = "Adds an 'eff' subscript.", wordTrig = false },
		{
			t("_{\\text{eff}}"),
		},
		{ condition = in_mathzone }
