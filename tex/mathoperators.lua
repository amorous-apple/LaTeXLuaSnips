...
s({trig="ddt",snippetType="autosnippet",dscr="double dot accent (double Time derivative)",wordTrig = false},
fmta("\\ddot{<>}",{i(1)}),{condition = in_mathzone}),
s({trig="br",snippetType="autosnippet",dscr="bar accent",wordTrig = false},
